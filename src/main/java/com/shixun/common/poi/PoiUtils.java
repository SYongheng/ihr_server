package com.shixun.common.poi;

import com.shixun.bean.*;
...
public class PoiUtils {
     ...
     *
     * @param file         Excel文件
     * @param maxWorkId    最大工号
     * @param allNations   民族列表
     * @param allPolitics  政治面貌列表
     * @param allDeps      部门列表
     * @param allPos       职位列表
     * @param allJobLevels 职称列表
     * @return 返回员工列表
     */
    public static List<Employee> importEmp2List(MultipartFile file, Long maxWorkId,
                            ...
                            case STRING: {
                                ...
                                switch (k) {
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        //工号不断获取数据库中最大工号，加一在赋值
                                        employee.setWorkID(String.format("%08d", ++maxWorkId));
                                        break;
                                    case 3:
